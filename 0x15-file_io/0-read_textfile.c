/* File0: A func to read text file and print it to the POSIX stdo */
#include "main.h"

/**
 * read_textfile - func that reads text file and prints
 * @filename: is the file to read
 * @letters: number of letters to read and print from file
 *
 * Return: 0 if it fails or actual number readable and printable
*/
